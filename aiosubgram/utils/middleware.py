...
class OPMiddleware(BaseMiddleware):
    def __init__(self, client: SubgramClient, max_sponsors: int = 5,
        ...
        Args:
            ...
            max_sponsors (int, optional): Максимальное количество спонсоров. По умолчанию: 5.
            sub_text (str, optional): Текст на кнопке подписки. По умолчанию: "Чтобы получить доступ к боту, подпишитесь:".
            channel_text (str, optional): Текст на кнопке для каналов. По умолчанию: "➕ Подписаться".
            bot_text (str, optional): Текст на кнопке для ботов. По умолчанию: "➕ Перейти в бота".
            smart_link_text (str, optional): Текст на кнопке для смарт-ссылок. По умолчанию: "➕ Перейти".
            resource_text (str, optional): Текст на кнопке для внешних ресурсов. По умолчанию: "➕ Перейти".
            done_button_text (str, optional): Текст на кнопке "Я подписался!". По умолчанию: "✅ Я подписался!"
        """
        self.client = client
